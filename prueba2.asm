...
_Fin_bucle DB "Fin bucle", 0
_I_PROGRAMA DD ?
_Inicia_bucle_DO_UNTIL DB "Inicia bucle DO-UNTIL", 0
...
MOV EAX, 0
MOV _I_PROGRAMA, EAX
invoke printf, ADDR _format_string, ADDR _Inicia_bucle_DO_UNTIL
_label0:
MOV EAX, _I_PROGRAMA
ADD EAX, 1
MOV _aux_long, EAX
MOV EAX, _aux_long
MOV _I_PROGRAMA, EAX
invoke printf, ADDR _format_long, _I_PROGRAMA
MOV EAX, _I_PROGRAMA
CMP EAX, 3
JL _label0
invoke printf, ADDR _format_string, ADDR _Fin_bucle
