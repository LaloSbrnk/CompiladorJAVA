...
public class ASE extends AccionSemantica{
    ...
    public void ejecutar(Token token, char c) {
        ...
        // Obtener el número de línea y la posición para todos los errores
        ...
        switch (AnalizadorLexico.estado_actual) {
            case 0:
                // Error desde el estado inicial (0)
                if (c == '%') {
            ...
            case 13:
                if (c == '\n') {
                    ...
                    mensajeError = "ERROR: Cadena mal cerrada. Se esperaba '\"'."; // Esto puede pasar si el archivo termina
                }
                break;
            ...
            default:
                // Un error genérico si un estado no está cubierto
