...
public class NodoAsignacion extends Nodo {
    ...
    // --- MÉTODO MODIFICADO (PARA CORRECCIÓN 3) ---
    @Override
    public String generarCodigo(GeneradorAssembler G, TablaDeAmbitos TdA) {
        ...
        // No generar código si la asignación es incompatible (ya reportado en chequear)
        if (tipoVar.equals("long") && tipoExpr.equals("dfloat")) {
            return null;
        }
        ...
        if (tipoVar.equals("long")) {
            ...
            if (tipoExpr.equals("long")) {
                // Conversión Implícita (Tema 30) 
                G.convertirLongADFloat(resExpr); // FILD 
            } else {
                // dfloat -> dfloat
